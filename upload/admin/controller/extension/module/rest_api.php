...
class ControllerExtensionModuleRestApi extends Controller
{
	...
	public function install()
	{
		...
		$settings['module_rest_api_status'] = 1;
		$this->model_setting_setting->editSetting('module_rest_api_status', $settings);
	...
	{
		$this->load->model('setting/setting');
		$settings['module_rest_api_status'] = 0;
		$this->model_setting_setting->editSetting('module_rest_api_status', $settings);
	...
	protected function getForm()
	{
		...
		if (isset($this->request->post['module_rest_api_status'])) {
			$data['module_rest_api_status'] = $this->request->post['module_rest_api_status'];
		} elseif (!empty($api_info)) {
			$data['module_rest_api_status'] = $api_info['status'];
		} else {
			$data['module_rest_api_status'] = $this->config->get('module_rest_api_status');
		}
